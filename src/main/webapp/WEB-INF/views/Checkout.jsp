...
${message}
	...
	<form action="placeOrder?cartId=${cart.cartId}" method="post" style="text-align: left;">
		...
		<p>Last Name : <input name="emailAddress" value="${user.lastName}"/></p>
		<p>Address : <input name="emailAddress" value="${user.address}"/></p>
		<p>Phone Number : <input name="emailAddress" value="${user.phoneNumber}"/></p>
