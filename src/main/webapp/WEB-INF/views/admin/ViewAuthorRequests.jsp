...
<div id="mainWrapper">
  <header> 
    ...
    <div id="logo"> 
      <!-- Company Logo text --> 
      <a href="/KamranBookStore/home"> <img src="../images/bookstore-logo.jpg" width="248" height="134" alt=""/> </a></div>
  ...
  <div id="content">
    ...
    <div class="mainContent">
      <h1>View Author Requests</h1>
${message}

<a href="/KamranBookStore/admin/viewRejectedAuthors">View Rejected Authors</a>
...
<table>
	...
	<c:forEach items="${list}" var="a">
		<tr style="font-weight: normal">
			<th style="font-weight: normal">${a.firstName}</th>
			<th style="font-weight: normal">${a.lastName}</th>
			<th style="font-weight: normal">${a.address}</th>
			<th style="font-weight: normal">${a.phoneNumber}</th>
			<th style="font-weight: normal"><a href="approveRequest?emailAddress=${a.emailAddress}">Approve</a> / <a href="rejectRequest?emailAddress=${a.emailAddress}">Reject</a></th>
		</tr>
	</c:forEach>
	</table>
