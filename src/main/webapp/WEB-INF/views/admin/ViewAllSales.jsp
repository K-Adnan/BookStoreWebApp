...
<table>
		<tr>
			<th style="width: 700px">Book Title</th>
			<th style="width: 50px">Number Sold</th>
			<th style="width: 50px">Unit Price</th>
			<th style="width: 100px">Total Sales</th>
		</tr>
	<c:forEach items="${booksList}" var="b">
		<tr>
			<th style="width: 700px; text-align:left; font-weight:normal">${b.title}</th>
			<th style="width: 50px; font-weight:normal">${b.sales}</th>
			<th style="width: 50px; font-weight:normal">${b.price}</th>
			<th style="width: 100px; font-weight:normal">${b.sales * b.price}</th>
		</tr>
	</c:forEach>
	</table>
